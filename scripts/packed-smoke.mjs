...
try {
  ...
  await run(process.execPath, ["--input-type=module", "--eval", [
    ...
    'const explorer = await import("@pieceful/ravel-explorer");',
    'const explorerBrowser = await import("@pieceful/ravel-explorer/browser");',
    ...
    'const browserHost = await import("@pieceful/ravel-host-browser");',
    ...
    'if (typeof explorer.createExplorerSnapshot !== "function") process.exit(1);',
    'if (typeof explorerBrowser.createExplorerElements !== "function") process.exit(1);',
    'if (typeof browserHost.renderMarkdownDocument !== "function") process.exit(1);',
    ...
    'const browserResult = browserHost.renderMarkdownDocument("```javascript {.ravel #main type=js}\\nconsole.log(42);\\n```\\n\\n```ravel\\nout(\\"dist/browser.js\\", _\\"main.js\\")\\n```\\n", { uri: "browser.md" });',
    'if (!browserResult.ok || browserResult.deliverables[0]?.value !== "console.log(42);\\n") process.exit(1);',
    'const browserSnapshot = explorer.createExplorerSnapshot(browserResult.program);',
    'if (explorerBrowser.createExplorerElements(browserSnapshot).length < 2) process.exit(1);',
