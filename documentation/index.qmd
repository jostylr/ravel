...
<p class="hero-note">Explicit execution · Browser-safe core · Source-linked diagnostics</p>
:::
...
Ravel 0.2 combines dependable static weaving with bounded, explicitly opted-in
live JavaScript: Markdown fences become a portable Ravel Map, the core resolves
a graph, and hosts decide where artifacts may be written or executed.
