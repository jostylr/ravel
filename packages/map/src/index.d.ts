...
export interface RavelChunk { id: string; identity: ChunkIdentity; body: string; source: SourceLocation; name?: string; definitionPipeline?: unknown[]; metadata?: Record<string, unknown>; fragments?: Array<{ body: string; source: SourceLocation }>; }
